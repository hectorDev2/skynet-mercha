...
export default function sculpture () {
  return (
    <Layout>
      <Hero
        title='Tazas y detalles'
        userLabel='gente cool'
        subtitle='explora nuestra gran variadad de tazas y regalos personalizados.'
        theme='secondary'
      >
            ...
            <div className='flex-col p-6 space-y-1 flex md:flex-row justify-start items-start gap-4'>
              ...
              <div>
                ...
                <p className='text-muted-foreground text-md mt-2'>
                  Nuestras creaciones pasaron por un proceso de creatividad e
                  innovacion.
                </p>
              </div>
            </div>

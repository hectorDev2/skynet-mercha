...
import { categoriesJacket, labels, tag } from "@/db/dataNew";
import ImageUpload from "@/app/components/shared/ImageUpload";

import { Button } from "@nextui-org/react";
import { useFormTshirtPOST } from "../../hook/useFormTshirtPOST";
import { useFormJacketPOST } from "../../hook/useFormJacketPOST";

export const AddFormJacket = () => {
...
"
      ...
      <div className="mb-5">
        ...
        >
          ...
          {categoriesJacket?.map(({ id, category }) => (

...
export const CardFeature = ({
  title = 'Calidad',
  subtitle = 'la calidad de nuestros productos',
  icon = (
    <svg
  ...
  return (
    <div className='rounded-lg border text-card-foreground shadow-sm bg-muted/50'>
      <div className='flex flex-col space-y-1.5 p-6'>
        <h3 className='text-2xl font-semibold leading-none tracking-tight grid gap-4 place-items-center'>
          {icon}
          {title}
        </h3>
      </div>
      <div className='p-6 pt-0'>{subtitle}</div>
    </div>
  )
}

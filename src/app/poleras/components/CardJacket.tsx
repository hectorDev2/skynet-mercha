...
export const CardJacket = ({
  ...
  return (
    <div
      ...
      className={`flex flex-col justify-between mt-7 h-[375px] m-6 relative overflow-hidden   rounded-xl max-w-xs`}
    >
      ...
      <div className="relative flex items-center justify-center">
        <img
          className="relative  w-[200px] hover:scale-110 transition-all ease-linear hover:rotate-3"

export const features = [
  {
    title: 'calidad',
    subtitle: 'todos nuestros productos garantizan una buena calidad y estilo',
    icon: (
      <svg
        stroke='#f596d3'
  ...
  {
    title: 'Exclusividad',
    subtitle: 'Todos nuestros modelos son exclusivos y creados por skynet',
    icon: (
      <svg
        stroke='#f596d3'
        xmlns='http://www.w3.org/2000/svg'
        className='w-14 icon icon-tabler icon-tabler-vip'
        viewBox='0 0 24 24'
        strokeWidth='1.5'
        fill='none'
        strokeLinecap='round'
  ...
  },
  {
    ...
    subtitle: 'Todas las piezas son creadas a mano, modelado y confeccion',
    icon: (
      <svg
        stroke='#f596d3'
        xmlns='http://www.w3.org/2000/svg'
  ...
  {
    title: 'Regalos',
    subtitle: 'Regala detalles atravez de divertidos e innovadores modelos',
    icon: (
      <svg
        stroke='#f596d3'
        xmlns='http://www.w3.org/2000/svg'
